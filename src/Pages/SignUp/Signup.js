    ...
    return (
        <div className="hero min-h-screen">
            <div className="hero-content grid grid-cols-1 gap-20 md:gap-24 lg:gap-24 md:grid-cols-2 lg:grid-cols-2 flex-col lg:flex-row">
                ...
                <div  className="w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-600 text-white">
                    <h1 className="text-2xl font-bold text-center">Register</h1>
                    <form className="space-y-6 ng-untouched ng-pristine ng-valid">
                        <div className="space-y-1 text-sm">
                            <label htmlFor="Name" className="block dark:text-gray-400">Name</label>
                            <input type="text" name="name" id="username" placeholder="Your Name" className="w-full px-4 py-3 rounded-md dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 focus:dark:border-violet-400" />
                        </div>
                        <div className="space-y-1 text-sm">
                        ...
                        <button className="block w-full p-3  text-center rounded-sm dark:text-gray-900 bg-yellow-500">Sign Up</button>
                    </form>
