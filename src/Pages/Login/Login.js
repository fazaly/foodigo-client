...
const Login = () => {
    ...
    const handleLogIn = event => {
        ...
        .then( result => {
            ...
            // get jwt token
            fetch('https://b6a11-service-review-server-side-fazaly.vercel.app/jwt', {
                method: 'POST',
                headers: {
            ...
            <div className="hero-content grid grid-cols-1 gap-20 md:gap-24 lg:gap-24 md:grid-cols-2 lg:grid-cols-2 flex-col lg:flex-row">
                ...
                <div  className="w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-600 text-white">
                    ...
                    <form onSubmit={handleLogIn} className="space-y-6 ng-untouched ng-pristine ng-valid">
                        ...
                        <button className="block w-full p-3  text-center rounded-sm dark:text-gray-900 bg-yellow-500">Sign in</button>
                    </form>
